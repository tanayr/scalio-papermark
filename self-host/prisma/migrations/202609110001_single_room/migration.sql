...
-- CreateEnum
CREATE TYPE "DocumentStorageType" AS ENUM ('LOCAL_PATH', 'S3_PATH', 'VERCEL_BLOB');
...
CREATE TABLE "AccessChallenge" (
    ...
    CONSTRAINT "AccessChallenge_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "AccessSession" (
    ...
    CONSTRAINT "AccessSession_pkey" PRIMARY KEY ("tokenHash")
);
...
-- CreateIndex
CREATE INDEX "AccessChallenge_email_createdAt_idx" ON "AccessChallenge"("email", "createdAt");
